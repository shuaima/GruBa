...
\stitle{Exp-1: Interest Extraction}
%
Fig.\ \ref{fig:fe} shows the testing results of using various $\alpha$ values.
We report the interest accuracy with various $\alpha$ values. Suppose that the label set manually labeled for each microblog is $A$, the label set that our method labeled is $B$. The interest accuracy is defined as $\frac{ A \cap B }{ A \cup B }$.
...
\begin{minipage}{.5\textwidth}
  \centering
\includegraphics[width=.85\linewidth]{figures/Interests}
\caption{Interest Extraction: Varying $\alpha$.}
\label{fig:fe}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
\includegraphics[width=.8\linewidth]{figures/clustering}
...
\begin{figure*}[tb!]
%\centering
  \subfigure[\sys{} Vs. LRC-BQ]{
    \label{fig:10-a}
    %\vspace{2ex}
    \includegraphics[width=0.5\textwidth]{figures/precision-1.eps}}
 % \hspace{0.5in}
   \subfigure[Varying Items]{
   %\vspace{2ex}
    \label{fig:11-a}
  \includegraphics[width=0.5\textwidth]{figures/precisionofdifferentfeatures.eps}}
  %\vspace{-1ex}
...
\vspace{-2ex}
  ...
  \subfigure[]{
      ...
      \includegraphics[width=0.36\textwidth]{IMAGE/features/userFeatures/1.eps}}
  \subfigure[]{
      \label{fig:userFeatures:uf-2}
      \includegraphics[width=0.36\textwidth]{IMAGE/features/userFeatures/2.eps}}
  \subfigure[]{
      \label{fig:userFeatures:uf-3}
      \includegraphics[width=0.36\textwidth]{IMAGE/features/userFeatures/3.eps}}
  \subfigure[]{
      \label{fig:userFeatures:uf-4}
      \includegraphics[width=0.36\textwidth]{IMAGE/features/userFeatures/4.eps}}
  \subfigure[]{
      \label{fig:userFeatures:uf-5}
      \includegraphics[width=0.36\textwidth]{IMAGE/features/userFeatures/5.eps}}
  \subfigure[]{
      \label{fig:userFeatures:uf-6}
      \includegraphics[width=0.36\textwidth]{IMAGE/features/userFeatures/6.eps}}
  \subfigure[]{
      \label{fig:userFeatures:uf-7}
      \includegraphics[width=0.36\textwidth]{IMAGE/features/userFeatures/7.eps}}
  \subfigure[]{
      \label{fig:userFeatures:uf-8}
      \includegraphics[width=0.36\textwidth]{IMAGE/features/userFeatures/8.eps}}
...
%\noindent\textbf{Summary}. %From these experimental results we find the followings.
%(1) We design a novel method to extract users' explicit/implicit interests, and case studies show that our method is effective.
