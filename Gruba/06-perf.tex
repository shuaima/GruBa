...
\begin{figure}[!htb]
\centering
\includegraphics[width=.7\linewidth]{figures/clustering}
...
\begin{figure*}
  ...
  \subfigure[Precision]{
    \label{fig:10-a}
    \includegraphics[width=0.3\textwidth]{figures/precision.eps}}
  %\hspace{1in}
  \subfigure[Recall]{
    \label{fig:10-b}
    \includegraphics[width=0.3\textwidth]{figures/recall.eps}}
  %\hspace{1in}
  \subfigure[$F_1$ Score]{
    \label{fig:10-c}
    \includegraphics[width=0.3\textwidth]{figures/F-Measure.eps}}
...
\begin{figure*}
  ...
  \subfigure[Precision]{
    \label{fig:11-a}
    \includegraphics[width=0.3\textwidth]{figures/precisionofdifferentfeatures.eps}}
  %\hspace{1in}
  \subfigure[Recall]{
    \label{fig:11-b}
    \includegraphics[width=0.3\textwidth]{figures/recallofdifferentfeatures.eps}}
  %\hspace{1in}
  \subfigure[$F_1$ Score]{
    \label{fig:11-c}
    \includegraphics[width=0.3\textwidth]{figures/fmeasureofdifferentfeatures.eps}}
