...
\begin{figure*}[tb!]
	...
	\begin{center}
		...
		\begin{minipage}[t]{0.4\textwidth}
			\vspace{2ex}
			\begin{center}
				\subfigure[{Unboundedness of unit data update}]{\label{fig-inc-complexity-data}
		...
		\begin{minipage}[t]{0.4\textwidth}
			%\vspace{-20.3ex}
			\begin{center}
				\subfigure[{Unboundedness of unit pattern update}]{\label{fig-inc-complexity-pattern}
					\includegraphics[scale=0.28]{./fig/inc-complexity-proof-pattern.eps}}
			\end{center}
			\vspace{-3.5ex}
		\end{minipage}
	\end{center}
...
%By (I) and (II), we have proven that the algorithm is correct.
