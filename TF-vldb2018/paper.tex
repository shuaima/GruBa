...
Second, we formulate and study the dynamic top-$k$ team formation problem due to the growing need of a dynamic environment.
To continuously deal with both pattern and data updates, we develop an unified incremental approach with an optimization to handle continuous pattern and data updates, separately and simultaneously. 
\eat{
To
