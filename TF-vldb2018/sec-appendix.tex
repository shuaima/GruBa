...
\noindent
{\textbf{3. Algorithm \kw{PFrag} (Section~\ref{sec-dynamictopk})}}
...
We will prove the proposition by contradiction.
When $\Delta P$ comes, the perfect graphs must reside in the balls that match with each pattern fragment of $P\oplus \Delta P$.
...
\identifyaffball filters out the balls that cannot match all fragments,	and there are no data updates on the ball.
