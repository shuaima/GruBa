...
\noindent
{\textbf{1. Procedure \rgraphsim (Section~\ref{subsec-teamF})}}
...
\vspace{-2ex}
\mat{0ex}{
\sstab {\sl Input:\/} Pattern graph $P(V_{P}, E_{P})$, ball $\ball([v, r])$.\\
...
\noindent
{\textbf{3. Algorithm \kw{PFrag} (Section~\ref{subsec-framework})}}

Algorithm \kw{PFrag} works by connecting the {\em pattern fragmentation} problem to the
...
\myhrule \vspace{-2ex}
\mat{0ex}{
\sstab {\sl Input:\/} \= Pattern graph $P(V_{P},E_{P})$, integer $h$.\\
...
\noindent
{\textbf{1. Proof of Proposition~\ref{thm-inc-grouprec-pat}}}
...
\includegraphics[scale=0.395]{./fig/youtube-pattern-deletion.eps}}
\hspace{-1.7ex}
\subfigure[{\scriptsize Varying $|\Delta P|$ (insertions)}]{\label{fig-exp-patinc-ins-youtube}
\includegraphics[scale=0.395]{./fig/youtube-pattern-insertion.eps}}
\hspace{-1.7ex}
\subfigure[{\scriptsize Varying $|\Delta P|$ (capacity)}]{\label{fig-exp-patinc-cap-youtube}
\includegraphics[scale=0.395]{./fig/youtube-pattern-capchange.eps}}
\hspace{-1.7ex}
\subfigure[{\scriptsize Varying $|\Delta P|$ (hybrid updates)}]{\label{fig-exp-patinc-hyb-youtube}
\includegraphics[scale=0.395]{./fig/youtube-pattern-hybrid.eps}}
\vspace{-2.5ex}

%\hspace{-5.5ex}
\subfigure[{\scriptsize Varying $|\Delta G|$ (deletions)}]{\label{fig-exp-datainc-del-youtube}
\includegraphics[scale=0.395]{./fig/youtube-data-deletion.eps}}
\hspace{-1.7ex}
\subfigure[{\scriptsize Varying $|\Delta G|$ (insertions)}]{\label{fig-exp-datainc-ins-youtube}
\includegraphics[scale=0.395]{./fig/youtube-data-insertion.eps}}
\hspace{-1.7ex}
\subfigure[{\scriptsize Varying $|\Delta G|$ (hybrid updates)}]{\label{fig-exp-datainc-hyb-youtube}
\includegraphics[scale=0.395]{./fig/youtube-data-hybrid.eps}}
\hspace{-1.7ex}
\subfigure[{\scriptsize Vary $(|\Delta P|,|\Delta G|)$ (simultaneous)}\hspace{-4.5ex}]{\label{fig-exp-hyb-patdata-youtube}
\includegraphics[scale=0.395]{./fig/youtube-pattern-data.eps}}
\vspace{-2.5ex}

%\hspace{-5.5ex}
\subfigure[{\scriptsize Varying $|\Delta P|$ in update sets}]{\label{fig-exp-patinc-multi-youtube}
\includegraphics[scale=0.395]{./fig/youtube-pattern-multi.eps}}
%\hspace{-1.7ex}
\subfigure[{\scriptsize Varying $|\Delta G|$ in update sets}]{\label{fig-exp-datainc-multi-youtube}
\includegraphics[scale=0.395]{./fig/youtube-data-multi.eps}}
%\hspace{-1.7ex}
\subfigure[{\scriptsize Varying $(|\Delta P|,|\Delta G|)$ in update sets}\hspace{-5.5ex}]{\label{fig-exp-hyb-datapat-multi-youtube}
\includegraphics[scale=0.395]{./fig/youtube-pattern-data-multi.eps}}
%\hfill
\vspace{-2.5ex}
...
\noindent
{\textbf{2. Proof of Proposition~\ref{prop-fragmentation}}}
...
\vspace{-0.5ex}
The experimental results on a real-life dataset \youtube are reported here.

{\em \youtube}~\cite{youtubeWeb} contains 2.03M video nodes and 12.2M edges, which represent recommendations between two videos. We used the undirected version, and generated 400 labels based on the built-in categories and ages of videos.

\vspace{-1.8ex}
\stitle{Exp-1: Performance of \optgrouprec}. We firstly evaluated the performance of \optgrouprec vs. \mindia, \minsumdis, \denalk on \youtube \wrt three measurements.
...
\vspace{-1.8ex}
\stitle{Exp-2: Efficiency of \inc for one set of updates}. Varying the amount of updates in one update set from 4.5\% to 45\% for pattern updates, 2.5\% to 25\% for data updates, and (4.5\%, 2.5\%) to (31.5\%, 17.5\%) for simultaneous updates, the results are reported in Fig.~\ref{fig-exp-patinc-del-youtube} to~\ref{fig-exp-hyb-patdata-youtube}.
We find \inc outperforms \optgrouprec when $\Delta P$, $\Delta G$ and $(\Delta P$, $\Delta G)$ are no more than 31.5\%, 20\% and (27\%, 15\%).
