...
\vspace{0.8ex}
Intuitively, we want (1) to avoid skewed updates by balancing the sizes of all fragments and (2) to minimize the efforts to assemble the partial matches of all fragments.
...
\revise{The bi-criteria optimization problem partitions a pattern into $h$ components of roughly equal size
