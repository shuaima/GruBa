...
\ni (3) We also used real-life dataset \youtube~\cite{youtubeWeb}. The description of the dataset can be found in the full version~\cite{fullvldb18}. 
...
(a) \mindia is to minimize the team diameter~\cite{Lappas09}, and is firstly proposed for the team formation problem;
...
Among algorithms for \teamF, most of them including  \mindia and \denalk only compute the best team,
...
Aqll the findings on \youtube are reported in the Appendix.
...
\stitle{Exp-2: Effectiveness of \optgrouprec}.  We generated pattern graphs for \optgrouprec, and the corresponding queries (labels requirements) for \mindia, \minsumdis and \denalk, and checked the quality of matches returned by them. 
\looseness=-1
