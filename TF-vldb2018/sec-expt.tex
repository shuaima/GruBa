...
\revise{and is firstly proposed for the team formation problem;}
...
Among algorithms for \teamF, \revise{most of them including  \mindia and \denalk only compute the best team,}
...
(2) The densities of teams found by \optgrouprec, though are smaller than \denalk which is specialized for maximizing team densities, are larger than \mindia and \minsumdis, as shown Fig.~\ref{fig-exp-semantic-citation-density}.
...
(4) The teams found by \optgrouprec come with a higher edge satisfiability , \ie 1.0 in all cases, compared to smaller than 0.6 by \mindia, \minsumdis and \denalk, as shown in Fig.~\ref{fig-exp-semantic-citation-link}.
...
\revise{These verify that \optgrouprec can effectively preserve structural and capacity constraints for top-$k$ team formation \wrt edge and capacity satisfiability, and pertains a good team collaboration compatibility \wrt density and diameter.}
