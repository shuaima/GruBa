...
\revise{One can verify that none of existing methods suffice to identify the above desired teams.
...
she may find $P_1$ is too restrictive to find sensible matches.
