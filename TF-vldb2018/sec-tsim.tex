...
\sstab(2) Different from strong simulation with balls having a fixed radius (\ie the diameter of a pattern), team simulation adopts a more natural setting that the radius of the balls is flexible, only less than a user specified upper bound.
