...
\revise{
We devise an algorithm \grouprec for \teamF, with one novel feature and two optimizations, \ie pattern satisfiability check, and incremental computing for radius varied balls and density based filtering optimization, compared with traditional algorithms for strong simulation~\cite{MaCFHW14}.}
