...
It then computes perfect subgraphs $G'_{s}$ of $P$ in inner balls $\ball{[v,t]}$ by invoking \incsim, an extension of the incremental algorithm in \cite{FanWW13-tods} and checking capacity bounds (lines 9-11, see~\cite{fullvldb18}).}
