...
\stab{\bf (1) Identifying affected balls}. 
...
\stab{\bf (2) Updating Fragment-Ball matches}. We then update the partial match relations for \affballsx in $\tilde{M}(P,G)$ \wrt $\Delta P$,
...
\stab{\bf (4) Early return optimization technique}. 
...
\stab{\bf (5) The complete algorithm for pattern updates}.
